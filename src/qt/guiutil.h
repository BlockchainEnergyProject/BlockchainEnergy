...
/** Utility functions used by the Blockchainenergy Qt UI.
 */
namespace GUIUtil
{
...
// Render Blockchainenergy addresses in monospace font
...
// Parse "blockchainenergy:" URI into recipient object, return true on successful parsing
