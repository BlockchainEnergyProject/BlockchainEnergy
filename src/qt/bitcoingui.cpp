                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BlockchainEnergy Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BlockchainEnergy address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blockchainenergy: URIs)"));
    ...
    privacyAction = new QAction(QIcon(":/icons/privacy"), tr("&Community"), this);
    privacyAction->setStatusTip(tr("Privacy Actions for zBCE"));
    privacyAction->setToolTip(privacyAction->statusTip());
    privacyAction->setCheckable(false);
#ifdef Q_OS_MAC
    ...
    governanceAction = new QAction(QIcon(":/icons/governance"), tr("&Exchange"), this);
    governanceAction->setStatusTip(tr("Show Proposals"));
    governanceAction->setToolTip(governanceAction->statusTip());
    governanceAction->setCheckable(false);
#ifdef Q_OS_MAC
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BlockchainEnergy Core"), this);
    aboutAction->setStatusTip(tr("Show information about BlockchainEnergy Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for BlockchainEnergy"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BlockchainEnergy addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BlockchainEnergy addresses"));
    ...
    openAction->setStatusTip(tr("Open a BlockchainEnergy: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BlockchainEnergy Core help message to get a list with possible BlockchainEnergy command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BlockchainEnergy Core client") + " " + networkStyle->getTitleAddText();
...
{
    governanceAction->setChecked(false);
    QDesktopServices::openUrl(QUrl("https://exchange.tlsgroup.io", QUrl::TolerantMode));
}
...
void BitcoinGUI::gotoPrivacyPage()
{
    ...
    QDesktopServices::openUrl(QUrl("https://discord.gg/9E6tTw6", QUrl::TolerantMode));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlockchainEnergy network", "", count));
}
...
{
    QString strTitle = tr("BlockchainEnergy Core"); // default title
    ...
    // Append title to "BlockchainEnergy - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
