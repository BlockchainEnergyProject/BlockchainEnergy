...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BlockchainEnergy Core"),
     ...
     * override -datadir in the blockchainenergy.conf file in the default data directory
     * (to be consistent with blockchainenergyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
