                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBCEPathCustom = GetArg("-zbcebackuppath", "");
    ...
    if(!strzBCEPathCustom.empty()) {
        ui->wallet_customzbcebackuppath->setText(QString::fromStdString(strzBCEPathCustom));
        ui->wallet_customzbcebackuppath_label->setVisible(true);
        ui->wallet_customzbcebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBCEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BlockchainEnergy RPC console.") + "<br>" +
