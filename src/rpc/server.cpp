...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchainenergy", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"blockchainenergy", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"blockchainenergy", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"blockchainenergy", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blockchainenergy", "masternodedebug", &masternodedebug, true, true, false},
        {"blockchainenergy", "startmasternode", &startmasternode, true, true, false},
        {"blockchainenergy", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blockchainenergy", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blockchainenergy", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blockchainenergy", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blockchainenergy", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blockchainenergy", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blockchainenergy", "preparebudget", &preparebudget, true, true, false},
        {"blockchainenergy", "submitbudget", &submitbudget, true, true, false},
        {"blockchainenergy", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blockchainenergy", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blockchainenergy", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blockchainenergy", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blockchainenergy", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blockchainenergy", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blockchainenergy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blockchainenergy", "checkbudgets", &checkbudgets, true, true, false},
        {"blockchainenergy", "mnsync", &mnsync, true, true, false},
        {"blockchainenergy", "spork", &spork, true, true, false},
        {"blockchainenergy", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbceseed", &getzbceseed, false, false, true},
        {"zerocoin", "setzbceseed", &setzbceseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbce", &searchdzbce, false, false, true},
        {"zerocoin", "dzbcestate", &dzbcestate, false, false, true},
...
{
    return "> blockchainenergy-cli " + methodname + " " + args + "\n";
}
