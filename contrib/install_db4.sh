...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the blockchainenergy repository."
  exit 1
fi
...
echo
echo 'When compiling blockchainenergyd, run `./configure` in the following way:'
echo
