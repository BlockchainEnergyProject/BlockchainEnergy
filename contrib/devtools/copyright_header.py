...
EXCLUDE = [
    # auto generated:
    'src/qt/blockchainenergystrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Blockchainenergy developers\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Blockchainenergy developers'
...
Arguments:
    <base_directory> - The base directory of a blockchainenergy source code repository.
"""
